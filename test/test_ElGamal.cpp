...
TEST(test_ElGamal, ElGamal_Cryptosystem)
{
    ...
    const auto encryption = crypto::algos::ElGamal_Encryption(29,  // a
                                                              23,  // b
                                                              89,  // modulo (p)
                                                              57,  // A's secret key
                                                              72); // message
    ...
    const auto decryption = crypto::algos::ElGamal_Decryption(29, // a
                                                              23, // b
...
*/ 
    ...
    auto bad_encryption = crypto::algos::ElGamal_Encryption(9,   // a
                                                            13,  // b
                                                            53,  // modulo (p)
                                                            8,   // A's secret key
                                                            21); // message
    ...
    auto bad_decryption = crypto::algos::ElGamal_Decryption(9,  // a
                                                            13, // b
